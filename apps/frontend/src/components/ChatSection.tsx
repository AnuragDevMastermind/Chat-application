...
import ic_person_1_color from "../assets/images/ic_person_1_color.png";
...
const ChatSection: React.FC<ChatSectionProp> = ({ friend }) => {
  ...
  return (
    <div className="flex-1 bg-[#FFFAF6] flex">
      <div className="w-[1px] h-full bg-slate-300" />
      <div className="flex-1 relative">
        <div className="absolute w-full h-screen py-5 flex flex-col">
          <div className="h-16 flex justify-between ms-5">
            <div className="h-10 flex">
              ...
              <div className="ms-4">
                ...
                <div className="flex items-center">
                  ...
                  <p className="ms-1 text-xs font-semibold font-serif text-gray-500">
