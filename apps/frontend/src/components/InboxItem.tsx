...
function InboxItem({ conversation, active }: InboxItemProps) {
  ...
  return (
    <div
      ...
      className={`${
        active
          ? 'w-[calc(100%-24px)] rounded-xl px-3 py-3 mt-2 flex bg-[#FFEBD9]'
    ...
    >
      ...
      <div>
        ...
        <p className="text-xs font-serif font-semibold text-gray-400">
          {conversation.lastMessage}
        </p>
      </div>

      <p className="flex-1 text-right text-sm font-serif font-semibold text-gray-400">
